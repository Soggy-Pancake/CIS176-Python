This is my repo for all of my Python programming class assignments. `Main.py` imports and lists all assignments made under the `Assignments` folder with a menu to select and run them. 
